...
def main():
    ...
    parser.add_argument('--input_dir', type=str,
                        help='The input directory containing documents to process', required=False, default="/home/ubuntu/ucllm_nedo_prod_kawagoshi/pipeline/3_download_preprocessed_datasets_merge_datasets/output")
    parser.add_argument('--output_dir', type=str,
                        help='The input file containing documents to process', required=False, default="/home/ubuntu/ucllm_nedo_prod_kawagoshi/pipeline/4_dedup_dataset/output")
