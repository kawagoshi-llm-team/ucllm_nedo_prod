...
#mport download_dirty_datasets

from download_dirty_datasets.download import c4, wikipedia, redpajama

#ROOT_PATH = pathlib.Path(download_dirty_datasets.__path__[0]).resolve().parent
...
def parse_args():
    ...
    parser.add_argument("--output_base", type=str, default="~/ucllm_nedo_prod_kawagoshi/pipeline/0_download_dirty_datasets/output",
