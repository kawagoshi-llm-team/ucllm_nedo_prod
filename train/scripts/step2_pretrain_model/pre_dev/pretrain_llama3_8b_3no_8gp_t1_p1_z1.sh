...
#Llama 8.0B
HIDDEN_SIZE=4096 # e.g. mistral-7b: 4096
FFN_HIDDEN_SIZE=14336 # e.g. mistral-7b: 14337
NUM_LAYERS=32 # e.g. mistral-7b: 32 
NUM_HEADS=32 # e.g. mistral-7b: 3
SEQ_LENGTH=4096 #: 32768
